...
/**
 * Marks an Extension so a default HTTP {@link SoapTransportProvider} is added to the transports that the extension can use
 * to dispatch the Soap messages.
 * <p>
...
@Retention(RUNTIME)
@Documented
public @interface DefaultHttpTransportProvider {
