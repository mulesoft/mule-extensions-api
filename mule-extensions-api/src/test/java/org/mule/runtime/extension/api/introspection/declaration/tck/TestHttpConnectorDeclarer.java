 ...
 * LICENSE.txt file.
 */
package org.mule.runtime.extension.api.introspection.declaration.tck;
...
public class TestHttpConnectorDeclarer
{
    ...
    public TestHttpConnectorDeclarer() {
        ...
        listenerRequester.withMessageSource(LISTEN_MESSAGE_SOURCE)
                .whichReturns(InputStream.class)
                .withAttributesOfType(Serializable.class)
                .sourceCreatedBy(() -> source)
                .withOptionalParameter(PORT).ofType(Integer.class).defaultingTo(DEFAULT_PORT);
    }
