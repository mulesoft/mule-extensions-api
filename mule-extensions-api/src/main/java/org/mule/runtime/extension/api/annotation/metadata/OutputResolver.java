...
public @interface OutputResolver {
  ...
  /**
   * Specifies the {@link OutputTypeResolver} which should be used to resolve the type of the
   ...
   * for operations which return collections, this should not return an {@link ArrayType} but
   * the type of the items inside the collection.
   * <p>
   * So, if the operation returns {@code List<Apple>}, this should return a {@link MetadataType}
   * for the {@code Apple}. Also, if the operation returns {@code List<Result<Apple, AppleAttributes>>},
   * it still should only return the {@code Apple's} metadata.
   *
   ...
   * <p>
   * So, if the operation returns {@code List<Apple>}, this should return a {@link MetadataType}
   * for attributes which describe the {@code Apple}, not the list. . Also, if the operation returns
   * {@code List<Result<Apple, AppleAttributes>>}, it still should only describe {@code AppleAttributes}.
   *
