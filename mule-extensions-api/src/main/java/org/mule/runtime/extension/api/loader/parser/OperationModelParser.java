...
public interface OperationModelParser extends SemanticTermsParser, AdditionalPropertiesModelParser, StereotypeModelParser,
  ...
  /**
   * Returns the {@link CompletableComponentExecutorFactory} which will be used to create the {@link CompletableComponentExecutor}
   * that brings the operation to life.
   *
   * @return a {@link CompletableComponentExecutorFactory}
   */
  Optional<CompletableComponentExecutorFactory<?>> getExecutor();
  ...
  /**
   * @return a {@link MediaTypeParser} describing the operation's output mimeType, if one was defined
   */
  Optional<MediaTypeParser> getMediaType();

  /**
   * @return an {@link Optional} {@link SdkExceptionHandlerFactory} if an exception handler was defined for this operation.
   */
  Optional<SdkExceptionHandlerFactory> getExceptionHandlerFactory();
