...
public final class MuleStereotypes {
  ...
  public static final StereotypeDefinition CONFIG_DEFINITION = new ConfigStereotype();
  ...
  public static final StereotypeDefinition APP_CONFIGURATION_DEFINITION = new ConfigurationStereotype();
  ...
  public static final StereotypeModel APP_CONFIGURATION =
      newStereotype(APP_CONFIGURATION_DEFINITION.getName(), STEREOTYPE_NAMESPACE).build();
