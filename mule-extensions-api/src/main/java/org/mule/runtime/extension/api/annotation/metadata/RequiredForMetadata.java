 ...
 * </p>
 * This parameter has the same effect when getting values from a operation's {@link org.mule.runtime.extension.api.values.ValueProvider}.
 * Any config or connection parameter that affects
 * the resolution of a {@link org.mule.runtime.extension.api.values.ValueProvider} that is linked to an operation
