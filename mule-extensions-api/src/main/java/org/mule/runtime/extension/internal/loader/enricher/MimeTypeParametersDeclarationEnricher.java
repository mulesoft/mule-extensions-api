 ...
 * A {@link MimeTypeParametersDeclarationEnricher#MIME_TYPE_PARAMETER_NAME} that allows configuring the mimeType to
 * the output operation payload and a {@link MimeTypeParametersDeclarationEnricher#ENCODING_PARAMETER_NAME} that allows
 * configuring the encoding to the output operation payload.
 * <p>
