...
public class ImmutableOperationModel extends AbstractExecutableComponentModel implements OperationModel {
   ...
   *             {@link #ImmutableOperationModel(String, String, List, List, OutputModel, OutputModel, boolean, ExecutionType, boolean, boolean, boolean, DisplayModel, Set, StereotypeModel, Set, Set, DeprecatedModel)}
   *             instead
   */
  @Deprecated
  ...
  public ImmutableOperationModel(String name,
    ...
    super(name, description, parameterGroupModels, output, outputAttributes, requiresConnection, transactional, supportsStreaming,
          displayModel, errors, stereotype, modelProperties, nestedComponents, notifications, deprecatedModel);
