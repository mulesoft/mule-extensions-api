 ...
 * @since 1.0
 */
public class ExpirationPolicyTypeBuilder extends InfrastructureTypeBuilder {

  public MetadataType buildExpirationPolicyType() {
    final ObjectTypeBuilder type = create(MetadataFormat.JAVA).objectType().id(ExpirationPolicy.class.getName())
        .with(new InfrastructureTypeAnnotation())
        .description(EXPIRATION_POLICY_DESCRIPTION_DESCRIPTION);
