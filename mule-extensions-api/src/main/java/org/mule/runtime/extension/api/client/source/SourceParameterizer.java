...
public interface SourceParameterizer {
  ...
  SourceParameterizer withConfigRef(String configurationName);
   ...
   */
  SourceParameterizer withParameter(String parameterName, Object value);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withParameter(String parameterGroup, String parameterName, Object value);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withSimpleReconnection(int frequency, int maxAttempts);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer reconnectingForever(int frequency);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withDefaultRepeatableStreaming();
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withInMemoryRepeatableStreaming(DataSize initialBufferSize,
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withFileStoreRepeatableStreaming(DataSize maxInMemorySize);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withDefaultRepeatableIterables();
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withInMemoryRepeatableIterables(int initialBufferSize, int bufferSizeIncrement, int maxBufferSize);
   ...
   * @return {@code this} instance
   */
  SourceParameterizer withFileStoreRepeatableIterables(int maxInMemoryInstances);
}
