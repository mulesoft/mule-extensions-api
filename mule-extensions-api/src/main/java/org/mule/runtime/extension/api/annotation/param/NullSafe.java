 ...
 *    </pre>
 * <p>
 * A null safe parameter of type HelloWorld would be created with the greeting field
 * assigned to {@code Hello world!}
 * </li>
 * <li>Basic types: String, numbers, dates, etc, are not supported. A
 * {@link IllegalParameterModelDefinitionException} will be thrown by the runtime if used in parameters
 * of such type</li>
 * </ul>
 *
 * @since 1.0
